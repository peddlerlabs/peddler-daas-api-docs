...
query the manifest:
- *Stringified* query string - This is the <span style={{color: 'green'}}>RECOMMENDED</span> method of querying the manifest.
...
### Querying the manifest using *stringified* query string
...
```json title="Response body"
{
	"data": [{
		...
		"trackingUrl": "https://pdlr.nl/track/PDXXXXXXXXX1",
		"consignee": {
			"address": {
				"name": "PDC 01 AMS",
			...
			"events": [{
				...
				},
				{
					...
					"details": {
						...
						"courierName": "jay",
						"courierComment": "FRONT_DOOR",
						"deliveredAtNeighbours": "46 John M. Keynesplein",
						"podSignatureUrl": "https://cdb.peddler.com/podsig/XXXXXXXXXX.png"
					}
				},
				{
