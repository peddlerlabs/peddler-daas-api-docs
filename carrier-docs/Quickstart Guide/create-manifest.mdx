...
| ``carrierServiceLevel`` | <span style={{color: 'green'}}>RECOMMENDED</span> | string | Possible values: ``NEXT_DAY_48`` (DEFAULT), ``NEXT_DAY_60``, ``SAME_DAY_24``, ``SAME_DAY_SAT_24``, ``SAME_DAY_SUN_24``, ``EXPRESS_0900``, ``EXPRESS_1030``, ``EXPRESS_1200``, ``EXPRESS_1700``, ``EXPRESS_1800``, ``EXPRESS_2200``, ``EXPRESS_SAT``, ``EXPRESS_SUN``, ``INSTANT_02`` |
